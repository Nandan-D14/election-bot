        ...
        return (
          <div className={`${styles.centerContent} ${styles.animateIn}`}>
            ...
            <p className={styles.description}>
              Take this 30-second official readiness check to see your eligibility and get a
        ...
        return (
          <div className={`${styles.questionCard} ${styles.animateIn}`}>
            ...
            <h3 className={styles.questionText}>
              Are you 18 years of age or older (or turning 18 soon)?
            </h3>
            <div className={styles.options}>
              <button
                className={styles.btnOption}
                onClick={() => {
                  setAnswers((p) => ({ ...p, age: true }));
                  setStep("q3");
                }}
              >
                Yes, 18 or older
      ...
      case "q3":
        return (
          <div className={`${styles.questionCard} ${styles.animateIn}`}>
            ...
            <h3 className={styles.questionText}>
              Is your name currently on the Electoral Roll (Voter List)?
            </h3>
            <div className={styles.options}>
              <button
                className={styles.btnOption}
                onClick={() => {
                  setAnswers((p) => ({ ...p, registered: true }));
                  setStep("result");
                }}
              >
                Yes, I am registered
              ...
              <button
                className={styles.btnOption}
                onClick={() => {
                  setAnswers((p) => ({ ...p, registered: false }));
                  setStep("result");
                }}
              >
                No / I don&apos;t know
            ...
            {isReadyToVote ? (
              <>
                ...
                <div className={styles.checklist}>
                  ...
                  <ul>
                    ...
                    <li>
                      ✅ Carry your EPIC (Voter ID) or an approved alternative ID on polling day.
                    </li>
              ...
              <>
                ...
                <div className={styles.checklist}>
                  ...
                  <ul>
                    <li>
                      ⚠️ You meet the age and citizenship criteria, but aren&apos;t registered.
                    </li>
                    <li>
                      👉 Visit the <b>Voter Helpline App</b> or <b>voters.eci.gov.in</b>.
                    </li>
                    <li>
                      👉 Fill out <b>Form 6</b> online to get your name on the electoral roll.
                    </li>
                  </ul>
                </div>
              </>
              ...
              <>
                ...
                <div className={styles.checklist}>
                  ...
                  <ul>
                    {!answers.citizen && (
                      <li>Only Indian citizens are eligible to vote in Indian elections.</li>
                    )}
                    {!answers.age && (
                      <li>
                        You must be at least 18 years old on the qualifying date to register as a
                        voter.
                      </li>
                    )}
                  </ul>
