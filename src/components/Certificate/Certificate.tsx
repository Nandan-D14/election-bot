  ...
  return (
    <div className={`${styles.certificateCard} ${styles.animateIn}`}>
      ...
      <p className={styles.message}>
        You have successfully completed the <strong>Interactive EVM & VVPAT Simulation</strong>. You
        now know how to verify your details, cast your vote, and confirm it on the VVPAT.
      </p>
      ...
      <div className={styles.footer}>
        ...
        <button
          ...
          onClick={() => alert("Sharing functionality would open a native share sheet here!")}
        >
          Share Badge
        </button>
      </div>
