...
export default function VoiceAssistant({ audioState, onAudioStateChange }: VoiceAssistantProps) {
  ...
  const displayLevels = (audioState === 'listening' || audioState === 'speaking')
    ? audioLevels
    : [0.3, 0.3, 0.3, 0.3, 0.3];
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.orbContainer}>
        ...
        >
          {audioState === 'idle' && (
            <svg className={styles.orbIcon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
